...
def clean_album(df):
    ...
    v = v.astype(float)
    idx = df.VALUEUOM.fillna('').apply(lambda s: 'g/dL' in s.lower()) | df.MIMIC_LABEL.apply(lambda s: 'g/dL' in s.lower())
    v.loc[idx] = v[idx] * 10
    return v
...
def clean_HCT(df):
    ...
    v = v.astype(float)
    idx = df.VALUEUOM.fillna('').apply(lambda s: 'g/dL' in s.lower()) | df.MIMIC_LABEL.apply(
        lambda s: 'g/dL' in s.lower())
    v.loc[idx] = v[idx] / 100
    return v
...
clean_fns = {
    'D-Dimer': clean_lab,
    'Gamma Glutamyltransferase': clean_lab,
    'Carcinoembyronic Antigen(CEA)': clean_lab,
    'Albumin': clean_album,
    # 'Stool Color': clean_lab,
    'LDL cholesterol': clean_lab,
    'TCO2': clean_lab,
    'TG': clean_lab,
    'HDL cholesterol': clean_lab,
    'Red blood cell count': clean_lab,
    'Hematocrit': clean_HCT,
    'Creatinine': clean_lab,
    'Creatinine Kinase(CK)': clean_lab,
    'Creatine Kinase MB Isoenzyme': clean_lab,
    'Potassium': clean_lab,
    'Alkaline phosphate': clean_lab,
    'Lymphocytes': clean_lab,
    'Phosphate': clean_lab,
    'Chloride': clean_lab,
    'Magnesium': clean_lab,
    'Sodium': clean_lab,
    # 'Urine Leukocytes': clean_lab,
    'Uric acid': clean_lab,
    'Prothrombin time': clean_lab,
    'Lactic acid': clean_lab,
    'Lactate dehydrogenase': clean_lab,
    'Triiodothyronine(T3)': clean_lab,
    'Bicarbonate': clean_lab,
    'Iron': clean_lab,
    'Ferritin': clean_lab,
    'Vitamin B12': clean_lab,
    'Total Protein Pleural': clean_TPP,
    'Amylase': clean_lab,
    'Hemoglobin': clean_lab,
    # 'Blood culture': clean_lab,
    'Alpha Fetoprotein': clean_lab,
    'Vancomycin': clean_lab,
    'Folate': clean_lab,
    'Conjugated bilirubin': clean_lab,
    'Total cholesterol': clean_lab,
    'Total bilirubin': clean_lab,
    'Total protein': clean_TP,
    'Total calcium': clean_lab,
    'Total Iron Binding Capacity': clean_lab,
    'Heart Rate': clean_lab,
    'Respiratory rate': clean_lab,
    'Diastolic blood pressure': clean_dbp,
    'Systolic blood pressure': clean_sbp,
    'Temperature': clean_temperature
}
