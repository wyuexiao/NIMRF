...
parser.add_argument('--variable_map_file', type=str,
                    default=os.path.join(os.path.dirname(__file__), '../resources/itemid_to_variable_map_20221021.csv'),
...
# variables = ['Diastolic blood pressure', 'Glucose', 'Heart Rate', 'Height', 'Oxygen saturation', 'Respiratory rate', 'Systolic blood pressure', 'Temperature', 'Weight']
